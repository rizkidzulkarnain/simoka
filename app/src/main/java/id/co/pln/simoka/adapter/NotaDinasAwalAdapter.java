...
public class NotaDinasAwalAdapter extends RecyclerView.Adapter<NotaDinasAwalAdapter.ItemAnggaran> {
    ...
    public NotaDinasAwalAdapter(Context context) {
    ...
    private void prepareAnggaranTotal() {
        ...
        String aurl = config._BaseIP + "NotaDinas/listAnggaranNotaDinas";
        ...
        try {
            ...
            if (_JsonObj != null) {
                ...
                for (int i = 0; i < ajsonarr.length( ); i++) {
                    ...
                    String alabel1 = "B1 Perkuatan, Susut dan Revas";
    ...
    public ItemAnggaran onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext( ))
                .inflate(R.layout.activity_cardawalanggaran, parent, false);
    ...
    public void onBindViewHolder(ItemAnggaran holder, int position) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener( ) {
            ...
            public void onClick(View view) {
                Intent aintent = new Intent(view.getContext(), NotaDinasActivity.class);
